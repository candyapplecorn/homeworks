...
var fetchSearchGiphys = exports.fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
    return function (dispatch) {
        debugger;
        return _api_util2.default.fetchSearchGiphys(searchTerm).then(function (giphys) {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    window.store = store;
    window.APIUtils = _api_util2.default;
    window.RECEIVE_SEARCH_GIPHYS = _giphy_actions.RECEIVE_SEARCH_GIPHYS;
...
var APIUtil = {
    fetchSearchGiphys: function fetchSearchGiphys(searchTerm) {
        var queryString = 'http://api.giphy.com/v1/gifs/search?q=' + searchTerm + '&api_key=dc6zaTOxFJmzC&limit=2';
        return $.ajax({
            method: 'GET',
            url: queryString,
            type: 'JSON'
